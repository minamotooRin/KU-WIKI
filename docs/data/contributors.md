...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 10px; margin: 20px 0;">
  ...
  <a href="https://github.com/minamotooRin" title="minamotooRin (16 contributions)" style="text-decoration: none;">
  ...
  <a href="https://github.com/apps/github-actions" title="github-actions[bot] (4 contributions)" style="text-decoration: none;">
